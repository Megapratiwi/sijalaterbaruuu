...
Route::prefix('admin')->middleware('auth:admin')->group(function(){
    ...
    Route::post('storejurusan', [JurusanController::class, 'storejurusan']);
    Route::put('update_jurusan/{id}', [JurusanController::class, 'update_jurusan']);
    Route::delete('jurusan/{id}', [JurusanController::class, 'destroy']);

        //prodi
    Route::get('prodi', [ProdiController::class, 'index']);
    Route::get('editprodi/{id}', [ProdiController::class, 'editprodi']);
    ...
    Route::delete('prodi/{id}', [JurusanController::class, 'destroy']);

        //mahasiswa
    Route::get('mahasiswa', [MahasiswaController::class, 'index']);
    Route::put('setuju/{id_mahasiswa}', [MahasiswaController::class, 'setuju']);
    Route::put('tolak/{id_mahasiswa}', [MahasiswaController::class, 'tolak']);
    ...
    Route::delete('kluhan/{id}', [KeluhanController::class, 'destroy']);
    Route::put('proses/{id_keluhan}', [KeluhanController::class, 'proses']);
    Route::put('selesai/{id_keluhan}', [KeluhanController::class, 'selesai']);
...
//mahasiswa  
    Route::get('beranda_mahasiswa', [MahasiswaaController::class, 'showmahasiswa']);
    ...
    Route::get('edit_alatmahasiswa/{id}', [PeminjamanAlatMahasiswaController::class, 'edit_alatmahasiswa']);
