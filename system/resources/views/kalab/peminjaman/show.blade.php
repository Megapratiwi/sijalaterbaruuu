        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel">
                <dl class="row mt-2">
                    ...
                    <dd class="col-sm-9"> : {{ $peminjaman_kalab->tanggal_peminjaman }}</dd>

                    <dt class="col-sm-3">Tanggal Selesai</dt>
                    <dd class="col-sm-9"> : {{ $peminjaman_kalab->tanggal_selesai }}</dd>
                    ...
                    <dd class="col-sm-9"> : {{ $peminjaman_kalab->keperluan_alat }}</dd>
                </dl>
            </div>
            <div class="tab-pane fade" id="navs-pills-top-messages" role="tabpanel">
                ...
                <p class="mb-0">
                    <img src="{{ url("public/$peminjaman_kalab->foto") }}" alt=""style="width: 50%; height: 50%;">
                </p>
            </div>
        </div>
    </div>
