        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="navs-pills-top-home" role="tabpanel">
                <dl class="row mt-2">
                    ...
                    <dd class="col-sm-9"> : {{ $peminjaman_alatmahasiswa->laboratorium->nama_laboratorium }}</dd>

                    <dt class="col-sm-3">Nama Alat</dt>
                    <dd class="col-sm-9"> : {{ $peminjaman_alatmahasiswa->nama_alat }}</dd>
                    ...
                    <dd class="col-sm-9"> : {{ $peminjaman_alatmahasiswa->tanggal_peminjaman }}</dd>

                    <dt class="col-sm-3">Tanggal Selesai</dt>
                    <dd class="col-sm-9"> : {{ $peminjaman_alatmahasiswa->tanggal_selesai }}</dd>
                    ...
                    <dd class="col-sm-9"> : {{ $peminjaman_alatmahasiswa->deskripsi }}</dd>
                </dl>
            </div>
