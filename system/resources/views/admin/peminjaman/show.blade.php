...
@section('mega')
    <div class="col-xl-12">
    <h6 class="text-muted">Info Data Peminjaman</h6>
    <div class="nav-align-top mb-12">
        <ul class="nav nav-pills mb-6" role="tablist">
            ...
            <li class="nav-item">
                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-top-profile" aria-controls="navs-pills-top-profile" aria-selected="false">Perlengkapan</button>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="navs-pills-top-profile" role="tabpanel">
                <dl class="row mt-2">
                    ...
                    <dd class="col-sm-9"> : {{ $peminjaman->keperluan_alat }}</dd>

                    <dt class="col-sm-3">Tanggal Peminjaman</dt>
                    <dd class="col-sm-9"> : {{ $peminjaman->tanggal_peminjaman }}</dd>

                    <dt class="col-sm-3">Tanggal Selesai</dt>
                    <dd class="col-sm-9"> : {{ $peminjaman->tanggal_selesai }}</dd>
            ...
            <div class="tab-pane fade" id="navs-pills-top-messages" role="tabpanel">
                ...
                <p class="mb-0">
                    <img src="{{ url("public/$peminjaman->foto") }}" alt=""style="width: 50%; height: 50%;">
                </p>
            </div>
        </div>
    </div>
